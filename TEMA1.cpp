...
void TEMA1::Update(float deltaTimeSeconds)
{
    ...
    for (const auto& coordonate : listaSteluteEcran) {
       ...
       if (x_apasat_mouse >= 200 && x_apasat_mouse <= 300 && y_apasat_mouse <= 660 && y_apasat_mouse >= 560) {
           romb_mov = 1;
       }
       // ....
      ...
      // se face translatie dupa coordonatele de deplasare ale mouseului
       ...
       if (apasare_romb == 2) {
           ...
           if (romb_portocaliu == 1) {
               ...
               if (y_mouse_release >= 380 && y_mouse_release <= 470 && x_mouse_release >= 270 && x_mouse_release <= 330) {
                   ...
                   // cand pe acea linie am inamic sa iasa proiectil din romb
                   if (linie_sus == 1) {
                       centru_proiectil_rezultat = AparitieProiectil(1, 0.38, 0, deltaTimeSeconds, 320, 440);
                       // vreau sa dispara proiectilul care a atacat hexagonul
                       if (coliziune == 1) {
                           if (scalare_proiectil >= 0.0) {
                               scalare_proiectil += deltaTimeSeconds * -5;
               ...
               if (y_mouse_release >= 207 && y_mouse_release <= 297 && x_mouse_release >= 120 && x_mouse_release <= 180) {
                   ...
                   // cand pe acea linie am inamic sa iasa proiectil din romb
                   if (linie_mijloc == 1) {
                       centru_proiectil_rezultat = AparitieProiectil(1, 0.38, 0, deltaTimeSeconds, 260, 260);
                       // vreau sa dispara proiectilul care a atacat hexagonul
                       if (coliziune == 1) {
                           if (scalare_proiectil >= 0.0) {
                               scalare_proiectil += deltaTimeSeconds * -5;
           ...
           if (romb_mov == 1) {
               ...
               if (y_mouse_release >= 380 && y_mouse_release <= 470 && x_mouse_release >= 270 && x_mouse_release <= 330) {
                   ...
                   // cand pe acea linie am inamic sa iasa proiectil din romb
                   if (linie_sus == 1) {
                       centru_proiectil_rezultat = AparitieProiectil(0.612, 0, 1, deltaTimeSeconds, 320, 440);
                       // vreau sa dispara proiectilul care a atacat hexagonul
                       if (coliziune == 1) {
                           if (scalare_proiectil >= 0.0) {
                               scalare_proiectil += deltaTimeSeconds * -5;
               ...
               if (y_mouse_release >= 207 && y_mouse_release <= 297 && x_mouse_release >= 120 && x_mouse_release <= 180) {
                   ...
                   // cand pe acea linie am inamic sa iasa proiectil din romb
                   if (linie_mijloc == 1) {
                       centru_proiectil_rezultat = AparitieProiectil(0.612, 0, 1, deltaTimeSeconds, 260, 260);
                       // vreau sa dispara proiectilul care a atacat hexagonul
                       if (coliziune == 1) {
                           if (scalare_proiectil >= 0.0) {
                               scalare_proiectil += deltaTimeSeconds * -5;
       ...
       if (patrat_2 == 1) {
           ...
           if (mouse_dr_2 == 1) {
               cout << "in update " << x_apasat_mouse << " " << y_apasat_mouse << endl;
               cout << "in update release" << release_p1_x << " " << release_p1_y << endl;
               if (release_p2_x - 50 <= x_apasat_mouse <= release_p2_x + 50 && release_p2_y - 50 <= y_apasat_mouse <= release_p2_y + 50) {
                   cout << "in scalare " << endl;
                   if (scalare_romb_x >= 0.0) {
                       cout << "in if" << endl;
                       scalare_romb_x += deltaTimeSeconds * -0.2;
                       scalare_romb_y = scalare_romb_x;
...
void TEMA1::ColiziuneSH(glm::vec2 centru_hexagon, glm::vec2 centru_proiectil_rezultat) {
    ...
    if (distanta_centre != 0 && distanta_centre < 8) {
        ...
        coliziune = 1;
        /*cout << "distanta centre: " << distanta_centre << endl;
        cout << coliziune << endl;*/
...
// generez coordonate random pentru stelute/resurse
//float TEMA1::RandomFloat(float min, float max) {
...
void TEMA1::OnMouseBtnPress(int mouseX, int mouseY, int button, int mods)
{
    ...
    // apasare dreapta mouse pt disparitie romb
        ...
        x_apasat_mouse = mouseX;
        y_apasat_mouse = resolution.y - mouseY;
        cout << x_apasat_mouse << " " << y_apasat_mouse << endl ;
    }
